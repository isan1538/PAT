"""
Addressing the loss calculation inconsistency, now error is calculated only in training code
 

Pure transformer model without physics guidance:
python pat_training.py --alpha 0.0 --weight_pde 0.0 --weight_bc 0.0 --weight_ic 0.0 --M 20 --steps 5000
